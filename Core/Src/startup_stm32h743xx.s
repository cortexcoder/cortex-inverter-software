...
;* @brief     STM32H743xx Devices vector table for MDK-ARM toolchain.
;*            This module performs:
;*                - Set the initial SP
;*                - Set the initial PC == Reset_Handler
;*                - Set the vector table entries with the exceptions ISR address
;*                - Configure the clock system and the external SRAM mounted on 
;*                  STM32H743xx-EVAL board to be used as data memory (optional, 
...
__Vectors       DCD     __initial_sp       ; Top of Stack
                ...
                DCD     TIM1_TRG_COM_IRQHandler           ; TIM1 Trigger and Commutation Interrupt and TIM11                   
                ...
                DCD     0                                 ; Reserved              
                DCD     WAKEUP_PIN_IRQHandler              ; Wakeup pin interrupt(for available wake-up pin)
__Vectors_End
